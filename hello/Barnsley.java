/* ****************************************************************************
 *  Compilation:  javac-intros Barnsley.java
 *  Execution:    java-intros Barnsley n
 *  Dependencies: StdDraw.java
 *
 *  Play chaos game to produce Barnsley fern.
 *
 *  % java-intros Barnsley 10000
 *
 * ****************************************************************************/
...
public class Barnsley {
    ...
    public static void main(String[] args) {
        int n;        // number of points to draw
