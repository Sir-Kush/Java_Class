...
public class Stats5 {
    public static void main (String [] args){
        ...
        System.out.println("The Minimum of 5 random number is: " + min);
        System.out.println("The Maximum of 5 random number is: " + max);
        System.out.println("The AVerage of 5 random number is: " + average);
    }
